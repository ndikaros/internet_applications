...
Text.Cite_spans = Text.hasMany(Cite_span); 
...
Paper.create({
    ...
    authors.map(element =>{
        var entries =
        {
            ...
            settlement: element.affiliation.location.settlement,
            region: element.affiliation.location.region,
            country: element.affiliation.location.country,
